...
class PromptCreator:
    ...
    def __init__(self):
        ...
        self.base_instruction = "Answer the question based on the information in the image, caption and the context provided. Do not hallucinate or infer information from general knowledge."
    ...
    def _get_binary_instruction(self, question: str) -> str:
...
# Handle non-binary multiple choice
        ...
        # Handle binary questions
            ...
            return self._get_binary_instruction(example['question'])
